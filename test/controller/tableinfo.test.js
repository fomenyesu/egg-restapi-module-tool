    ...
    it('should status 200 and get the request body', () => {
      ...
      return request(app.callback())
        ...
        .send({
            "tableName":"nadmin",
            "data":[
            {"Field":"uid","Type":"int(10)","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},
            {"Field":"name","Type":"varchar(20)","Null":"NO","Key":"UNI","Default":null,"Extra":""},
            {"Field":"pass","Type":"varchar(50)","Null":"NO","Key":"","Default":null,"Extra":""},
            {"Field":"status","Type":"int(1)","Null":"NO","Key":"","Default":null,"Extra":""},
            {"Field":"time","Type":"int(11)","Null":"NO","Key":"","Default":null,"Extra":""}
            ]
          })
        .expect(200);
    });
    ...
    it('should status 200 and get the request body', () => {
      ...
      return request(app.callback())
        ...
        .send({
          "tableName":"nadmin",
          "data":[
          {"Field":"uid1","Type":"int(10)","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},
          {"Field":"name","Type":"varchar(20)","Null":"NO","Key":"UNI","Default":null,"Extra":""},
          {"Field":"pass","Type":"varchar(50)","Null":"NO","Key":"","Default":null,"Extra":""},
          {"Field":"status","Type":"int(1)","Null":"NO","Key":"","Default":null,"Extra":""},
          {"Field":"time","Type":"int(11)","Null":"NO","Key":"","Default":null,"Extra":""}
